    ...
    def render_card(
        ...
        if candidate:
            ...
            <div class="{css_class}">
                ...
                <hr>
                <div><b>Throughput:</b> {candidate['throughput']:.0f}/day</div>
                ...
                <div><b>Upgrade:</b> {candidate['upgrade_pct']}%</div>
                ...
                <div><b>Clinical access points:</b> {candidate['clinical_nodes']}</div>
        ...
        [
            {
                ...
                "Throughput/Day": candidate["throughput"],
