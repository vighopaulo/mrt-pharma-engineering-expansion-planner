...
## Version 1.0 final UI correction

The branding header uses a fixed two-zone desktop layout: product identity on the left and the engineering tagline aligned to the far right. It switches to left alignment on narrow screens.
